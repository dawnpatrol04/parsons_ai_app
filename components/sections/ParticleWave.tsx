  ...
  useFrame(({ clock }) => {
    if (points.current) {
      ...
      for (let i = 0; i < particlesCount; i++) {
        ...
        positionsArray[i3] = x + noise(x * 0.05, y * 0.05, time) * 0.5
        positionsArray[i3 + 1] = y + noise(x * 0.05, y * 0.05, time + 100) * 0.5
        positionsArray[i3 + 2] = z + noise(x * 0.05, y * 0.05, time + 200) * 0.5
      }
